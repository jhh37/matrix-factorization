...
T = table(...
  ...
  'VariableNames',{'ALGORITHM', 'CONV_RUNS', 'CONV_RATE', 'TIME_MED', 'M_TSS', 'STD_TSS', 'RUSSO_CONV', 'RUSSO_RATE', 'M_TRUSSO', 'STD_TRUSSO', 'TRIRUSSO_CONV', 'TRIRUSSO_RATE', 'SI_MED', 'FI_MED', 'ITERS_MED', 'ST_MED', 'FT_MED', 'IPS_MED', 'SI_AVR', 'FI_AVR', 'ITERS_AVR', 'ST_AVR', 'FT_AVR', 'TIME_AVR', 'IPS_AVR'});
